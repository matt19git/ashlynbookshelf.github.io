...
//
//  1) `pixels` – raw pixel offsets from the full-res image.
//     The app converts these to percentages at runtime.
//
//  2) `box` – pre-calculated percentage coordinates (0–100).
//     Use this if you've already normalised the values.
//
// The calibration helper (toggle CALIBRATION_MODE in app.js) will
// log both formats to the console and copy them to your clipboard.
...
export const books = [
  // ── Shelf 1 ─────────────────────────────────────────────────────────
  {
    ...
    coverUrl: "./assets/covers/range.jpg",
  ...
  },
  {
    ...
    coverUrl: "./assets/covers/pnin.jpg",
  ...
  },
  {
    ...
    coverUrl: "./assets/covers/a-man-called-ove.jpg",
